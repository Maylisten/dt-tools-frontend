...
import Particle, {defaultParticleFireOption} from "@/libs/ParticleFire/Particle.ts";
...
const options = {...defaultParticleFireOption};
// options.texture = ParticleOptions.texture.options[5];
// options.texture = "muzzle_02.png";
// options.color = [75, 75, 75];
